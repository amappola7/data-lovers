...
btnStartWelcomePage.addEventListener("click", () => {
    ...
    creatingHTMLElements.addCharacterList(HarryPotterData.goToNextPage(allCharacters,paginationElement()), "https://imagizer.imageshack.com/img923/332/wM4EDt.png", "list");
